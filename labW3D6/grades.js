...
It has a property “sid” (student id) and another property “answers”.  The answer property holds an array 
that records the students answers for the quiz. 
...
answer objects for every question so that once they are sorted they arrays will have the student answers
 and the corresponding key answer in the same position of each array. 
...
quiz.scoreStudent = function (sid) {
  const student = quiz.students.find(function (student) {
...
quiz.getAverage = function () {
  ...
  let average = totalCorrect / numOfStudents;
  return average;
};
